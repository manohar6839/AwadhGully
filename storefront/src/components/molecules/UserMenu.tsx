...
export const UserMenu: React.FC<{ isLogged: boolean }> = ({ isLogged }) => {
    ...
    // If not logged in, just show a link to sign-in page without dropdown
    if (!isLogged) {
        return (
            <Link href="/customer/sign-in" className="flex items-center justify-center p-2 rounded-lg cursor-pointer text-awadh-ivory hover:bg-white/10 transition-colors">
    ...
    return (
        <Dropdown>
            ...
            <HoverMenu customerMenu style={{ minWidth: 'auto' }}>
