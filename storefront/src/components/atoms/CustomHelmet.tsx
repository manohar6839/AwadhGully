...
export const CustomHelmet: React.FC<{
    ...
    let metaDescription = product?.description || collection?.description || 'Royal Awadhi Flavors, Modernly Served';
    ...
    const seo = {
        ...
        facebook: '',
        twitter: '',
        image: product?.featuredAsset?.preview || collection?.featuredAsset?.preview || `/logo.png`,
    };
...
const doStoreLD = () => {
    return {
        ...
        '@type': 'OnlineStore',
        name: 'Awadh Gully',
        description: 'Royal Awadhi Flavors, Modernly Served',
        image: '/logo.png',
        parentOrganization: {
            '@type': 'OnlineBusiness',
            name: 'Awadh Gully Foods Pvt. Ltd.',
            url: 'https://www.awadhgully.com',
        },
    };
};
