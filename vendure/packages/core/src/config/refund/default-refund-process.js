...
exports.defaultRefundProcess = {
    ...
    init: function (injector) {
        return __awaiter(this, void 0, void 0, function () {
            var ConfigService, HistoryService;
    ...
    onTransitionStart: function (fromState, toState, data) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, true];
        });
    }); },
    onTransitionEnd: function (fromState, toState, data) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!historyService) {
