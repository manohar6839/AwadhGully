...
var activeConfig;
var defaultConfigPath = path_1.default.join(__dirname, 'default-config');
/**
...
function setConfig(userConfig) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!!activeConfig) return [3 /*break*/, 2];
                    return [4 /*yield*/, Promise.resolve("".concat(defaultConfigPath)).then(function (s) { return require(s); })];
                case 1:
                    activeConfig = (_a.sent()).defaultConfig;
                    _a.label = 2;
                case 2:
