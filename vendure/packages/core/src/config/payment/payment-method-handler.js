 ...
 */
var PaymentMethodHandler = /** @class */ (function (_super) {
    __extends(PaymentMethodHandler, _super);
    function PaymentMethodHandler(config) {
        var _this = _super.call(this, config) || this;
        _this.createPaymentFn = config.createPayment;
        _this.settlePaymentFn = config.settlePayment;
        _this.cancelPaymentFn = config.cancelPayment;
        _this.createRefundFn = config.createRefund;
        _this.onTransitionStartFn = config.onStateTransitionStart;
        return _this;
    }
    /**
     * @description
     ...
     * @internal
     */
    PaymentMethodHandler.prototype.createPayment = function (ctx, order, amount, args, metadata, method) {
        return __awaiter(this, void 0, void 0, function () {
            var paymentConfig;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.createPaymentFn(ctx, order, amount, this.argsArrayToHash(args), metadata, method)];
                    case 1:
                        paymentConfig = _a.sent();
                        return [2 /*return*/, __assign({ method: this.code, metadata: {} }, paymentConfig)];
                }
            });
        });
    };
     ...
     * @internal
     */
    PaymentMethodHandler.prototype.settlePayment = function (ctx, order, payment, args, method) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.settlePaymentFn(ctx, order, payment, this.argsArrayToHash(args), method)];
            });
        });
    };
    /**
     ...
     * @internal
     */
    PaymentMethodHandler.prototype.cancelPayment = function (ctx, order, payment, args, method) {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                return [2 /*return*/, (_a = this.cancelPaymentFn) === null || _a === void 0 ? void 0 : _a.call(this, ctx, order, payment, this.argsArrayToHash(args), method)];
            });
        });
    };
    /**
     ...
     * @internal
     */
    PaymentMethodHandler.prototype.createRefund = function (ctx, input, amount, order, payment, args, method) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.createRefundFn
     ...
     * @internal
     */
    PaymentMethodHandler.prototype.onStateTransitionStart = function (fromState, toState, data) {
