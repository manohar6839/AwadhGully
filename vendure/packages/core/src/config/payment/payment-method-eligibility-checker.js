 ...
 * @docsWeight 0
 */
var PaymentMethodEligibilityChecker = /** @class */ (function (_super) {
    __extends(PaymentMethodEligibilityChecker, _super);
    function PaymentMethodEligibilityChecker(config) {
     ...
     * @internal
     */
    PaymentMethodEligibilityChecker.prototype.check = function (ctx, order, args, method) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.checkFn(ctx, order, this.argsArrayToHash(args), method)];
            });
        });
    };
    return PaymentMethodEligibilityChecker;
