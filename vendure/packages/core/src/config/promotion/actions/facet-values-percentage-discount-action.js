    ...
    execute: function (ctx, orderLine, args) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, facetValueChecker.hasFacetValues(orderLine, args.facets, ctx)];
                    case 1:
                        if (_a.sent()) {
                            unitPrice = ctx.channel.pricesIncludeTax ? orderLine.unitPriceWithTax : orderLine.unitPrice;
                            return [2 /*return*/, -unitPrice * (args.discount / 100)];
                        }
                        return [2 /*return*/, 0];
                }
            });
