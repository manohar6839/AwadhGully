 ...
 * @docsWeight 0
 */
var PromotionCondition = /** @class */ (function (_super) {
    __extends(PromotionCondition, _super);
    function PromotionCondition(config) {
        var _this = _super.call(this, config) || this;
        _this.checkFn = config.check;
        _this.priorityValue = config.priorityValue || 0;
        return _this;
    }
    Object.defineProperty(PromotionCondition.prototype, "code", {
        get: function () {
            return _super.prototype.code;
        },
        enumerable: false,
        configurable: true
    });
     ...
     */
    PromotionCondition.prototype.check = function (ctx, order, args, promotion) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.checkFn(ctx, order, this.argsArrayToHash(args), promotion)];
            });
        });
    };
