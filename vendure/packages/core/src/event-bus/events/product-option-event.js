 ...
 * @since 1.4
 */
var ProductOptionEvent = /** @class */ (function (_super) {
    __extends(ProductOptionEvent, _super);
    function ProductOptionEvent(ctx, entity, type, input) {
        return _super.call(this, entity, type, ctx, input) || this;
    }
    return ProductOptionEvent;
