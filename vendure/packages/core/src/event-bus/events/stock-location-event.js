 ...
 */
var StockLocationEvent = /** @class */ (function (_super) {
    __extends(StockLocationEvent, _super);
    function StockLocationEvent(ctx, entity, type, input) {
        return _super.call(this, entity, type, ctx, input) || this;
    }
    return StockLocationEvent;
