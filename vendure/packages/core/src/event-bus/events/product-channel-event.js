 ...
 */
var ProductChannelEvent = /** @class */ (function (_super) {
    __extends(ProductChannelEvent, _super);
    function ProductChannelEvent(ctx, product, channelId, type) {
