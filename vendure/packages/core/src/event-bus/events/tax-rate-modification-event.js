 ...
 */
var TaxRateModificationEvent = /** @class */ (function (_super) {
    __extends(TaxRateModificationEvent, _super);
    function TaxRateModificationEvent(ctx, taxRate) {
        var _this = _super.call(this) || this;
        _this.ctx = ctx;
        _this.taxRate = taxRate;
        return _this;
    }
    return TaxRateModificationEvent;
