 ...
 * @since 1.4
 */
var CustomerGroupEvent = /** @class */ (function (_super) {
    __extends(CustomerGroupEvent, _super);
    function CustomerGroupEvent(ctx, entity, type, input) {
        return _super.call(this, entity, type, ctx, input) || this;
    }
    return CustomerGroupEvent;
