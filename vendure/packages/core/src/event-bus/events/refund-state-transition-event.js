 ...
 */
var RefundStateTransitionEvent = /** @class */ (function (_super) {
    __extends(RefundStateTransitionEvent, _super);
    function RefundStateTransitionEvent(fromState, toState, ctx, refund, order) {
    ...
    return RefundStateTransitionEvent;
