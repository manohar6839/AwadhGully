 ...
 * @since 2.2.0
 */
var ProductVariantPriceEvent = /** @class */ (function (_super) {
    __extends(ProductVariantPriceEvent, _super);
    function ProductVariantPriceEvent(ctx, entity, type, input) {
        return _super.call(this, entity, type, ctx, input) || this;
    }
    return ProductVariantPriceEvent;
