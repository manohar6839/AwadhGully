 ...
 * @since 1.4
 */
var PasswordResetVerifiedEvent = /** @class */ (function (_super) {
    __extends(PasswordResetVerifiedEvent, _super);
    function PasswordResetVerifiedEvent(ctx, user) {
        var _this = _super.call(this) || this;
        _this.ctx = ctx;
        _this.user = user;
        return _this;
    }
    return PasswordResetVerifiedEvent;
