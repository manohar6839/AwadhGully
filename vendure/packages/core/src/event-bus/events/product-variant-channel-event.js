 ...
 */
var ProductVariantChannelEvent = /** @class */ (function (_super) {
    __extends(ProductVariantChannelEvent, _super);
    function ProductVariantChannelEvent(ctx, productVariant, channelId, type) {
        var _this = _super.call(this) || this;
        _this.ctx = ctx;
        _this.productVariant = productVariant;
        _this.channelId = channelId;
        _this.type = type;
        return _this;
    }
    return ProductVariantChannelEvent;
