...
var job_1 = require("../../job-queue/job");
/**
 * @description
...
var SearchService = function () {
    ...
    var SearchService = _classThis = /** @class */ (function () {
         ...
         * calls to.
         */
        SearchService_1.prototype.adopt = function (override) {
            this.override = override;
        };
        SearchService_1.prototype.reindex = function (ctx) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    if (this.override) {
                        return [2 /*return*/, this.override.reindex(ctx)];
                    }
                    if (!process.env.CI) {
                        vendure_logger_1.Logger.warn('The SearchService should be overridden by an appropriate search plugin.');
                    }
                    return [2 /*return*/, new job_1.Job({
                            queueName: 'error',
                            data: {},
                            id: 'error',
