...
var SlugValidator = function () {
    ...
    var _classThis;
    var SlugValidator = _classThis = /** @class */ (function () {
        function SlugValidator_1(connection) {
         ...
         * Mutates the input.
         */
        SlugValidator_1.prototype.validateSlugs = function (ctx, input, translationEntity) {
            return __awaiter(this, void 0, void 0, function () {
                var _i, _a, t, match, suffix, seen, alreadySuffixed, qb;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (!input.translations) return [3 /*break*/, 6];
                            _i = 0, _a = input.translations;
                            _b.label = 1;
                        case 1:
                            if (!(_i < _a.length)) return [3 /*break*/, 6];
                            t = _a[_i];
                            if (!t.slug) return [3 /*break*/, 5];
                        ...
                        case 2:
                            ...
                            if (seen.length) {
                                qb.andWhere('translation.id NOT IN (:...seen)', { seen: seen });
                            }
                            ...
                            if (match) {
                                if (!match.base.deletedAt) {
                                    ...
                                    if (alreadySuffixed.test(t.slug)) {
                                        t.slug = t.slug.replace(alreadySuffixed, "-".concat(suffix));
                                    }
                                    else {
                                        t.slug = "".concat(t.slug, "-").concat(suffix);
                                    }
                                }
                                else {
                                    seen.push(match.id);
        ...
        return SlugValidator_1;
    }());
    __setFunctionName(_classThis, "SlugValidator");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        SlugValidator = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return SlugValidator = _classThis;
}();
