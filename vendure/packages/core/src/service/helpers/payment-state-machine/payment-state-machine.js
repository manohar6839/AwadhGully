...
var PaymentStateMachine = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var PaymentStateMachine = _classThis = /** @class */ (function () {
        function PaymentStateMachine_1(configService) {
            this.configService = configService;
            this.initialState = 'Created';
            this.config = this.initConfig();
        }
        PaymentStateMachine_1.prototype.getInitialState = function () {
            return this.initialState;
        };
        PaymentStateMachine_1.prototype.canTransition = function (currentState, newState) {
            return new finite_state_machine_1.FSM(this.config, currentState).canTransitionTo(newState);
        };
        PaymentStateMachine_1.prototype.getNextStates = function (payment) {
            var fsm = new finite_state_machine_1.FSM(this.config, payment.state);
            return fsm.getNextStates();
        };
        PaymentStateMachine_1.prototype.transition = function (ctx, order, payment, state) {
            return __awaiter(this, void 0, void 0, function () {
                var fsm, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            fsm = new finite_state_machine_1.FSM(this.config, payment.state);
                            return [4 /*yield*/, fsm.transitionTo(state, { ctx: ctx, order: order, payment: payment })];
                        case 1:
                            result = _a.sent();
                            payment.state = state;
        ...
        PaymentStateMachine_1.prototype.initConfig = function () {
            var _this = this;
            var _a, _b;
            var paymentMethodHandlers = this.configService.paymentOptions.paymentMethodHandlers;
            var customProcesses = (_a = this.configService.paymentOptions.customPaymentProcess) !== null && _a !== void 0 ? _a : [];
            var processes = __spreadArray(__spreadArray([], customProcesses, true), ((_b = this.configService.paymentOptions.process) !== null && _b !== void 0 ? _b : []), true);
            ...
            if (validationResult.valid && validationResult.error) {
                vendure_logger_1.Logger.warn("Payment process: ".concat(validationResult.error));
            }
            return {
                transitions: allTransitions,
                onTransitionStart: function (fromState, toState, data) { return __awaiter(_this, void 0, void 0, function () {
                    var _i, processes_1, process_1, result, _a, paymentMethodHandlers_1, handler, result;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 3:
                                ...
                                return [3 /*break*/, 1];
                            case 4:
                                _a = 0, paymentMethodHandlers_1 = paymentMethodHandlers;
                                _b.label = 5;
                            case 5:
                                if (!(_a < paymentMethodHandlers_1.length)) return [3 /*break*/, 8];
                                handler = paymentMethodHandlers_1[_a];
                                if (!(data.payment.method === handler.code)) return [3 /*break*/, 7];
                                return [4 /*yield*/, (0, utils_1.awaitPromiseOrObservable)(handler.onStateTransitionStart(fromState, toState, data))];
                            case 6:
                                result = _b.sent();
                                if (result !== true) {
                                    return [2 /*return*/, result];
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 3:
                                _i++;
                                return [3 /*break*/, 1];
                            case 4: throw new errors_1.IllegalOperationError(message || 'error.cannot-transition-payment-from-to', {
                                fromState: fromState,
                                toState: toState,
                            });
                        }
        ...
        return PaymentStateMachine_1;
    }());
    __setFunctionName(_classThis, "PaymentStateMachine");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        PaymentStateMachine = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PaymentStateMachine = _classThis;
}();
