...
var OrderStateMachine = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var OrderStateMachine = _classThis = /** @class */ (function () {
        function OrderStateMachine_1(configService) {
            this.configService = configService;
            this.initialState = 'Created';
            this.config = this.initConfig();
        }
        OrderStateMachine_1.prototype.getInitialState = function () {
            return this.initialState;
        };
        OrderStateMachine_1.prototype.canTransition = function (currentState, newState) {
            return new finite_state_machine_1.FSM(this.config, currentState).canTransitionTo(newState);
        };
        OrderStateMachine_1.prototype.getNextStates = function (order) {
            var fsm = new finite_state_machine_1.FSM(this.config, order.state);
            return fsm.getNextStates();
        };
        OrderStateMachine_1.prototype.transition = function (ctx, order, state) {
            return __awaiter(this, void 0, void 0, function () {
                var fsm, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            fsm = new finite_state_machine_1.FSM(this.config, order.state);
                            return [4 /*yield*/, fsm.transitionTo(state, { ctx: ctx, order: order })];
                        case 1:
                            result = _a.sent();
        ...
        OrderStateMachine_1.prototype.initConfig = function () {
            var _this = this;
            var _a;
            var orderProcesses = (_a = this.configService.orderOptions.process) !== null && _a !== void 0 ? _a : [];
            var allTransitions = orderProcesses.reduce(function (transitions, process) {
            ...
            if (validationResult.valid && validationResult.error) {
                vendure_logger_1.Logger.warn("Order process: ".concat(validationResult.error));
            }
            return {
                transitions: allTransitions,
                onTransitionStart: function (fromState, toState, data) { return __awaiter(_this, void 0, void 0, function () {
                    var _i, orderProcesses_1, process_1, result;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _i = 0, orderProcesses_1 = orderProcesses;
                                _a.label = 1;
                            case 1:
                                if (!(_i < orderProcesses_1.length)) return [3 /*break*/, 4];
                                process_1 = orderProcesses_1[_i];
                ...
                onTransitionEnd: function (fromState, toState, data) { return __awaiter(_this, void 0, void 0, function () {
                    var _i, orderProcesses_2, process_2;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _i = 0, orderProcesses_2 = orderProcesses;
                                _a.label = 1;
                            case 1:
                                if (!(_i < orderProcesses_2.length)) return [3 /*break*/, 4];
                                process_2 = orderProcesses_2[_i];
                ...
                onError: function (fromState, toState, message) { return __awaiter(_this, void 0, void 0, function () {
                    var _i, orderProcesses_3, process_3;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _i = 0, orderProcesses_3 = orderProcesses;
                                _a.label = 1;
                            case 1:
                                if (!(_i < orderProcesses_3.length)) return [3 /*break*/, 4];
                                process_3 = orderProcesses_3[_i];
                            ...
                            case 3:
                                _i++;
                                return [3 /*break*/, 1];
                            case 4: throw new errors_1.IllegalOperationError(message || 'message.cannot-transition-order-from-to', {
                                fromState: fromState,
                                toState: toState,
                            });
                        }
        ...
        return OrderStateMachine_1;
    }());
    __setFunctionName(_classThis, "OrderStateMachine");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        OrderStateMachine = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return OrderStateMachine = _classThis;
}();
