...
var FulfillmentStateMachine = function () {
    var _classDecorators = [(0, common_1.Injectable)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var FulfillmentStateMachine = _classThis = /** @class */ (function () {
        function FulfillmentStateMachine_1(configService) {
            this.configService = configService;
            this.initialState = 'Created';
            this.config = this.initConfig();
        }
        FulfillmentStateMachine_1.prototype.getInitialState = function () {
            return this.initialState;
        };
        FulfillmentStateMachine_1.prototype.canTransition = function (currentState, newState) {
            return new finite_state_machine_1.FSM(this.config, currentState).canTransitionTo(newState);
        };
        FulfillmentStateMachine_1.prototype.getNextStates = function (fulfillment) {
            var fsm = new finite_state_machine_1.FSM(this.config, fulfillment.state);
            return fsm.getNextStates();
        };
        FulfillmentStateMachine_1.prototype.transition = function (ctx, fulfillment, orders, state) {
            return __awaiter(this, void 0, void 0, function () {
                var fsm, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            fsm = new finite_state_machine_1.FSM(this.config, fulfillment.state);
                            return [4 /*yield*/, fsm.transitionTo(state, { ctx: ctx, orders: orders, fulfillment: fulfillment })];
                        case 1:
                            result = _a.sent();
        ...
        FulfillmentStateMachine_1.prototype.initConfig = function () {
            var _this = this;
            var _a, _b;
            // TODO: remove once the customFulfillmentProcess option is removed
            var customProcesses = (_a = this.configService.shippingOptions.customFulfillmentProcess) !== null && _a !== void 0 ? _a : [];
            var processes = __spreadArray(__spreadArray([], customProcesses, true), ((_b = this.configService.shippingOptions.process) !== null && _b !== void 0 ? _b : []), true);
            ...
            if (validationResult.valid && validationResult.error) {
                vendure_logger_1.Logger.warn("Fulfillment process: ".concat(validationResult.error));
            }
            return {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 3:
                                _i++;
                                return [3 /*break*/, 1];
                            case 4: throw new errors_1.IllegalOperationError(message || 'error.cannot-transition-fulfillment-from-to', {
                                fromState: fromState,
                                toState: toState,
                            });
                        }
        ...
        return FulfillmentStateMachine_1;
    }());
    __setFunctionName(_classThis, "FulfillmentStateMachine");
    (function () {
