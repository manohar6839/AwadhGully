...
var permission_definition_1 = require("./permission-definition");
/**
...
exports.DEFAULT_PERMISSIONS = [
    ...
    new permission_definition_1.CrudPermissionDefinition('Catalog', function (operation) { return "Grants permission to ".concat(operation, " Products, Facets, Assets, Collections"); }),
    new permission_definition_1.CrudPermissionDefinition('Settings', function (operation) {
        return "Grants permission to ".concat(operation, " PaymentMethods, ShippingMethods, TaxCategories, TaxRates, Zones, Countries, System & GlobalSettings");
    }),
...
function getAllPermissionsMetadata(customPermissions) {
    var allPermissions = __spreadArray(__spreadArray([], exports.DEFAULT_PERMISSIONS, true), customPermissions, true);
    return allPermissions.reduce(function (all, def) { return __spreadArray(__spreadArray([], all, true), def.getMetadata(), true); }, []);
}
exports.CacheKey = {
