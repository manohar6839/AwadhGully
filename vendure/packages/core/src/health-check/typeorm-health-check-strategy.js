 ...
 */
var TypeORMHealthCheckStrategy = /** @class */ (function () {
    function TypeORMHealthCheckStrategy(options) {
        this.options = options;
    }
    TypeORMHealthCheckStrategy.prototype.init = function (injector) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, injector.resolve(terminus_1.TypeOrmHealthIndicator)];
                    case 1:
                        indicator = _a.sent();
                        return [2 /*return*/];
                }
    ...
    TypeORMHealthCheckStrategy.prototype.getHealthIndicator = function () {
        var _a, _b, _c;
        var key = ((_a = this.options) === null || _a === void 0 ? void 0 : _a.key) || 'database';
        var timeout = (_c = (_b = this.options) === null || _b === void 0 ? void 0 : _b.timeout) !== null && _c !== void 0 ? _c : 1000;
        return function () { return indicator.pingCheck(key, { timeout: timeout }); };
    };
    return TypeORMHealthCheckStrategy;
}());
