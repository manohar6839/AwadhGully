...
var CollectionAsset = function () {
    ...
    var CollectionAsset = _classThis = /** @class */ (function (_super) {
        __extends(CollectionAsset_1, _super);
        function CollectionAsset_1(input) {
            var _this = _super.call(this, input) || this;
            _this.collectionId = __runInitializers(_this, _collectionId_initializers, void 0);
            _this.collection = (__runInitializers(_this, _collectionId_extraInitializers), __runInitializers(_this, _collection_initializers, void 0));
            __runInitializers(_this, _collection_extraInitializers);
            return _this;
        }
        return CollectionAsset_1;
    }(_classSuper));
    __setFunctionName(_classThis, "CollectionAsset");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _collectionId_decorators = [(0, typeorm_1.Column)()];
        _collection_decorators = [(0, typeorm_1.Index)(), (0, typeorm_1.ManyToOne)(function (type) { return collection_entity_1.Collection; }, function (collection) { return collection.assets; }, { onDelete: 'CASCADE' })];
        ...
        CollectionAsset = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CollectionAsset = _classThis;
}();
