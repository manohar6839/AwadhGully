...
var CollectionTranslation = function () {
    ...
    var CollectionTranslation = _classThis = /** @class */ (function (_super) {
        __extends(CollectionTranslation_1, _super);
        function CollectionTranslation_1(input) {
            ...
            _this.base = (__runInitializers(_this, _description_extraInitializers), __runInitializers(_this, _base_initializers, void 0));
        ...
        return CollectionTranslation_1;
    }(_classSuper));
    __setFunctionName(_classThis, "CollectionTranslation");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _languageCode_decorators = [(0, typeorm_1.Column)('varchar')];
        _name_decorators = [(0, typeorm_1.Column)()];
        _slug_decorators = [(0, typeorm_1.Index)({ unique: false }), (0, typeorm_1.Column)()];
        _description_decorators = [(0, typeorm_1.Column)('text')];
        _base_decorators = [(0, typeorm_1.Index)(), (0, typeorm_1.ManyToOne)(function (type) { return collection_entity_1.Collection; }, function (base) { return base.translations; }, { onDelete: 'CASCADE' })];
        _customFields_decorators = [(0, typeorm_1.Column)(function (type) { return custom_entity_fields_1.CustomCollectionFieldsTranslation; })];
        ...
        CollectionTranslation = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CollectionTranslation = _classThis;
}();
