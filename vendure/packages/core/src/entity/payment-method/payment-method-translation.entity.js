...
var PaymentMethodTranslation = function () {
    ...
    var PaymentMethodTranslation = _classThis = /** @class */ (function (_super) {
        __extends(PaymentMethodTranslation_1, _super);
        function PaymentMethodTranslation_1(input) {
        ...
        return PaymentMethodTranslation_1;
    }(_classSuper));
    __setFunctionName(_classThis, "PaymentMethodTranslation");
    (function () {
        var _a;
        ...
        _base_decorators = [(0, typeorm_1.Index)(), (0, typeorm_1.ManyToOne)(function (type) { return payment_method_entity_1.PaymentMethod; }, function (base) { return base.translations; }, { onDelete: 'CASCADE' })];
        _customFields_decorators = [(0, typeorm_1.Column)(function (type) { return custom_entity_fields_1.CustomPaymentMethodFieldsTranslation; })];
        ...
        PaymentMethodTranslation = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PaymentMethodTranslation = _classThis;
}();
