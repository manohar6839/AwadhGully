...
var RefundLine = function () {
    ...
    var RefundLine = _classThis = /** @class */ (function (_super) {
        __extends(RefundLine_1, _super);
        function RefundLine_1(input) {
            var _this = _super.call(this, input) || this;
            _this.refund = __runInitializers(_this, _refund_initializers, void 0);
            _this.refundId = (__runInitializers(_this, _refund_extraInitializers), __runInitializers(_this, _refundId_initializers, void 0));
            __runInitializers(_this, _refundId_extraInitializers);
            return _this;
        }
        return RefundLine_1;
    }(_classSuper));
    __setFunctionName(_classThis, "RefundLine");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _refund_decorators = [(0, typeorm_1.Index)(), (0, typeorm_1.ManyToOne)(function (type) { return refund_entity_1.Refund; }, function (refund) { return refund.lines; })];
        _refundId_decorators = [(0, entity_id_decorator_1.EntityId)()];
        ...
        RefundLine = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return RefundLine = _classThis;
}();
