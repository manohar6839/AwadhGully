...
var Release = function () {
    ...
    var Release = _classThis = /** @class */ (function (_super) {
        __extends(Release_1, _super);
        function Release_1(input) {
            var _this = _super.call(this, input) || this;
            _this.type = generated_types_1.StockMovementType.RELEASE;
    ...
    __setFunctionName(_classThis, "Release");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _orderLine_decorators = [(0, typeorm_1.ManyToOne)(function (type) { return order_line_entity_1.OrderLine; })];
        ...
        Release = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Release = _classThis;
}();
