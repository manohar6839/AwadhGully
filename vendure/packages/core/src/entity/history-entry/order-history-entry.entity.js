 ...
 */
var OrderHistoryEntry = function () {
    ...
    var OrderHistoryEntry = _classThis = /** @class */ (function (_super) {
        __extends(OrderHistoryEntry_1, _super);
        function OrderHistoryEntry_1(input) {
            var _this = _super.call(this, input) || this;
            _this.order = __runInitializers(_this, _order_initializers, void 0);
            __runInitializers(_this, _order_extraInitializers);
            return _this;
        }
        return OrderHistoryEntry_1;
    }(_classSuper));
    __setFunctionName(_classThis, "OrderHistoryEntry");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _order_decorators = [(0, typeorm_1.Index)(), (0, typeorm_1.ManyToOne)(function (type) { return order_entity_1.Order; }, { onDelete: 'CASCADE' })];
        ...
        OrderHistoryEntry = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return OrderHistoryEntry = _classThis;
}();
