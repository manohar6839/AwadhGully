...
var history_entry_entity_1 = require("./history-entry.entity");
/**
 * @description
 ...
 */
var CustomerHistoryEntry = function () {
    var _classDecorators = [(0, typeorm_1.ChildEntity)()];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _classSuper = history_entry_entity_1.HistoryEntry;
    var _customer_decorators;
    var _customer_initializers = [];
    var _customer_extraInitializers = [];
    var CustomerHistoryEntry = _classThis = /** @class */ (function (_super) {
        __extends(CustomerHistoryEntry_1, _super);
        function CustomerHistoryEntry_1(input) {
            var _this = _super.call(this, input) || this;
            _this.customer = __runInitializers(_this, _customer_initializers, void 0);
            __runInitializers(_this, _customer_extraInitializers);
            return _this;
        }
        return CustomerHistoryEntry_1;
    }(_classSuper));
    __setFunctionName(_classThis, "CustomerHistoryEntry");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _customer_decorators = [(0, typeorm_1.Index)(), (0, typeorm_1.ManyToOne)(function (type) { return customer_entity_1.Customer; }, { onDelete: 'CASCADE' })];
        ...
        CustomerHistoryEntry = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return CustomerHistoryEntry = _classThis;
}();
