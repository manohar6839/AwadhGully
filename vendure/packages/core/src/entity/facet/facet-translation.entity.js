...
var facet_entity_1 = require("./facet.entity");
var FacetTranslation = function () {
    ...
    var FacetTranslation = _classThis = /** @class */ (function (_super) {
        __extends(FacetTranslation_1, _super);
        function FacetTranslation_1(input) {
        ...
        return FacetTranslation_1;
    }(_classSuper));
    __setFunctionName(_classThis, "FacetTranslation");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _languageCode_decorators = [(0, typeorm_1.Column)('varchar')];
        _name_decorators = [(0, typeorm_1.Column)()];
        _base_decorators = [(0, typeorm_1.Index)(), (0, typeorm_1.ManyToOne)(function (type) { return facet_entity_1.Facet; }, function (base) { return base.translations; }, { onDelete: 'CASCADE' })];
        _customFields_decorators = [(0, typeorm_1.Column)(function (type) { return custom_entity_fields_1.CustomFacetFieldsTranslation; })];
        ...
        FacetTranslation = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FacetTranslation = _classThis;
}();
