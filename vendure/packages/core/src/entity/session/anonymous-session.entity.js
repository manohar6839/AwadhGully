...
var AnonymousSession = function () {
    ...
    var AnonymousSession = _classThis = /** @class */ (function (_super) {
        __extends(AnonymousSession_1, _super);
        function AnonymousSession_1(input) {
            return _super.call(this, input) || this;
        }
        return AnonymousSession_1;
    }(_classSuper));
    __setFunctionName(_classThis, "AnonymousSession");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        AnonymousSession = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return AnonymousSession = _classThis;
}();
