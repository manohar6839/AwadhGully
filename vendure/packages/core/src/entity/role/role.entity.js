...
var Role = function () {
    ...
    var Role = _classThis = /** @class */ (function (_super) {
        ...
        function Role_1(input) {
            var _this = _super.call(this, input) || this;
            _this.code = __runInitializers(_this, _code_initializers, void 0);
            _this.description = (__runInitializers(_this, _code_extraInitializers), __runInitializers(_this, _description_initializers, void 0));
            _this.permissions = (__runInitializers(_this, _description_extraInitializers), __runInitializers(_this, _permissions_initializers, void 0));
            _this.channels = (__runInitializers(_this, _permissions_extraInitializers), __runInitializers(_this, _channels_initializers, void 0));
    ...
    (function () {
        ...
        _channels_decorators = [(0, typeorm_1.ManyToMany)(function (type) { return channel_entity_1.Channel; }, function (channel) { return channel.roles; }), (0, typeorm_1.JoinTable)()];
