...
var PromotionTranslation = function () {
    ...
    var PromotionTranslation = _classThis = /** @class */ (function (_super) {
        __extends(PromotionTranslation_1, _super);
        function PromotionTranslation_1(input) {
        ...
        return PromotionTranslation_1;
    }(_classSuper));
    __setFunctionName(_classThis, "PromotionTranslation");
    (function () {
        var _a;
        ...
        _base_decorators = [(0, typeorm_1.Index)(), (0, typeorm_1.ManyToOne)(function (type) { return promotion_entity_1.Promotion; }, function (base) { return base.translations; }, { onDelete: 'CASCADE' })];
        _customFields_decorators = [(0, typeorm_1.Column)(function (type) { return custom_entity_fields_1.CustomPromotionFieldsTranslation; })];
        ...
        PromotionTranslation = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return PromotionTranslation = _classThis;
}();
