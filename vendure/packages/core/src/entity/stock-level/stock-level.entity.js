...
var StockLevel = function () {
    var _classDecorators = [(0, typeorm_1.Entity)(), (0, typeorm_1.Index)(['productVariantId', 'stockLocationId'], { unique: true })];
    ...
    var _stockOnHand_decorators;
    var _stockOnHand_initializers = [];
    var _stockOnHand_extraInitializers = [];
    var _stockAllocated_decorators;
    var _stockAllocated_initializers = [];
    var _stockAllocated_extraInitializers = [];
    var _customFields_decorators;
    var _customFields_initializers = [];
    var _customFields_extraInitializers = [];
    var StockLevel = _classThis = /** @class */ (function (_super) {
        __extends(StockLevel_1, _super);
        function StockLevel_1(input) {
            var _this = _super.call(this, input) || this;
            _this.productVariant = __runInitializers(_this, _productVariant_initializers, void 0);
            ...
            _this.stockLocation = (__runInitializers(_this, _productVariantId_extraInitializers), __runInitializers(_this, _stockLocation_initializers, void 0));
            ...
            _this.stockOnHand = (__runInitializers(_this, _stockLocationId_extraInitializers), __runInitializers(_this, _stockOnHand_initializers, void 0));
            _this.stockAllocated = (__runInitializers(_this, _stockOnHand_extraInitializers), __runInitializers(_this, _stockAllocated_initializers, void 0));
            _this.customFields = (__runInitializers(_this, _stockAllocated_extraInitializers), __runInitializers(_this, _customFields_initializers, void 0));
            __runInitializers(_this, _customFields_extraInitializers);
            return _this;
        }
        return StockLevel_1;
    }(_classSuper));
    __setFunctionName(_classThis, "StockLevel");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _productVariant_decorators = [(0, typeorm_1.Index)(), (0, typeorm_1.ManyToOne)(function (type) { return product_variant_entity_1.ProductVariant; }, function (productVariant) { return productVariant.stockLevels; }, { onDelete: 'CASCADE' })];
        _productVariantId_decorators = [(0, entity_id_decorator_1.EntityId)()];
        _stockLocation_decorators = [(0, typeorm_1.Index)(), (0, typeorm_1.ManyToOne)(function (type) { return stock_location_entity_1.StockLocation; }, { onDelete: 'CASCADE' })];
        _stockLocationId_decorators = [(0, entity_id_decorator_1.EntityId)()];
        _stockOnHand_decorators = [(0, typeorm_1.Column)()];
        _stockAllocated_decorators = [(0, typeorm_1.Column)()];
        _customFields_decorators = [(0, typeorm_1.Column)(function (type) { return custom_entity_fields_1.CustomStockLevelFields; })];
        ...
        __esDecorate(null, null, _stockOnHand_decorators, { kind: "field", name: "stockOnHand", static: false, private: false, access: { has: function (obj) { return "stockOnHand" in obj; }, get: function (obj) { return obj.stockOnHand; }, set: function (obj, value) { obj.stockOnHand = value; } }, metadata: _metadata }, _stockOnHand_initializers, _stockOnHand_extraInitializers);
        __esDecorate(null, null, _stockAllocated_decorators, { kind: "field", name: "stockAllocated", static: false, private: false, access: { has: function (obj) { return "stockAllocated" in obj; }, get: function (obj) { return obj.stockAllocated; }, set: function (obj, value) { obj.stockAllocated = value; } }, metadata: _metadata }, _stockAllocated_initializers, _stockAllocated_extraInitializers);
        ...
        StockLevel = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return StockLevel = _classThis;
}();
