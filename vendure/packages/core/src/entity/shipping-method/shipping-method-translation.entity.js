...
var ShippingMethodTranslation = function () {
    ...
    var ShippingMethodTranslation = _classThis = /** @class */ (function (_super) {
        __extends(ShippingMethodTranslation_1, _super);
        function ShippingMethodTranslation_1(input) {
        ...
        return ShippingMethodTranslation_1;
    }(_classSuper));
    __setFunctionName(_classThis, "ShippingMethodTranslation");
    (function () {
        var _a;
        ...
        _base_decorators = [(0, typeorm_1.Index)(), (0, typeorm_1.ManyToOne)(function (type) { return shipping_method_entity_1.ShippingMethod; }, function (base) { return base.translations; }, { onDelete: 'CASCADE' })];
        _customFields_decorators = [(0, typeorm_1.Column)(function (type) { return custom_entity_fields_1.CustomShippingMethodFieldsTranslation; })];
        ...
        ShippingMethodTranslation = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ShippingMethodTranslation = _classThis;
}();
