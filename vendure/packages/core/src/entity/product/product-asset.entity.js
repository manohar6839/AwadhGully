...
var ProductAsset = function () {
    ...
    var ProductAsset = _classThis = /** @class */ (function (_super) {
        __extends(ProductAsset_1, _super);
        function ProductAsset_1(input) {
            ...
            __runInitializers(_this, _product_extraInitializers);
            return _this;
        }
        return ProductAsset_1;
    }(_classSuper));
    __setFunctionName(_classThis, "ProductAsset");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _productId_decorators = [(0, typeorm_1.Column)()];
        _product_decorators = [(0, typeorm_1.Index)(), (0, typeorm_1.ManyToOne)(function (type) { return product_entity_1.Product; }, function (product) { return product.assets; }, { onDelete: 'CASCADE' })];
        ...
        ProductAsset = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProductAsset = _classThis;
}();
