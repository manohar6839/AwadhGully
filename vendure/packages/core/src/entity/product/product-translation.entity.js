...
var ProductTranslation = function () {
    ...
    var ProductTranslation = _classThis = /** @class */ (function (_super) {
        __extends(ProductTranslation_1, _super);
        function ProductTranslation_1(input) {
        ...
        return ProductTranslation_1;
    }(_classSuper));
    __setFunctionName(_classThis, "ProductTranslation");
    (function () {
        var _a;
        ...
        _base_decorators = [(0, typeorm_1.Index)(), (0, typeorm_1.ManyToOne)(function (type) { return product_entity_1.Product; }, function (base) { return base.translations; })];
        _customFields_decorators = [(0, typeorm_1.Column)(function (type) { return custom_entity_fields_1.CustomProductFieldsTranslation; })];
        ...
        ProductTranslation = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProductTranslation = _classThis;
}();
