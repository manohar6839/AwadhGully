 ...
 * @since 3.4.0
 */
var SettingsStoreEntry = function () {
    var _classDecorators = [(0, typeorm_1.Entity)(), (0, typeorm_1.Index)('settings_store_key_scope_unique', ['key', 'scope'], { unique: true })];
    ...
    var SettingsStoreEntry = _classThis = /** @class */ (function (_super) {
        __extends(SettingsStoreEntry_1, _super);
        function SettingsStoreEntry_1(input) {
            var _this = _super.call(this, input) || this;
            /**
             * @description
             * The settings key, typically in the format 'namespace.fieldName'
             */
            _this.key = __runInitializers(_this, _key_initializers, void 0);
            /**
             * @description
             ...
             */
            _this.scope = (__runInitializers(_this, _value_extraInitializers), __runInitializers(_this, _scope_initializers, void 0));
            __runInitializers(_this, _scope_extraInitializers);
            return _this;
        }
        return SettingsStoreEntry_1;
    }(_classSuper));
    __setFunctionName(_classThis, "SettingsStoreEntry");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _key_decorators = [(0, typeorm_1.Index)(), (0, typeorm_1.Column)()];
        _value_decorators = [(0, typeorm_1.Column)('json', { nullable: true })];
        _scope_decorators = [(0, typeorm_1.Index)(), (0, typeorm_1.Column)({ type: 'varchar', nullable: true })];
        ...
        SettingsStoreEntry = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return SettingsStoreEntry = _classThis;
}();
