...
var VendureEntity = function () {
    ...
    return _a = /** @class */ (function () {
            function VendureEntity(input) {
                ...
                if (input) {
                    for (var _i = 0, _b = Object.entries(Object.getOwnPropertyDescriptors(input)); _i < _b.length; _i++) {
                        var _c = _b[_i], key = _c[0], descriptor = _c[1];
            ...
            return VendureEntity;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _id_decorators = [(0, entity_id_decorator_1.PrimaryGeneratedId)()];
