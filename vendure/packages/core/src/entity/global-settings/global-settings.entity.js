...
var GlobalSettings = function () {
    ...
    var _classThis;
    var _classSuper = __1.VendureEntity;
    var _availableLanguages_decorators;
    var _availableLanguages_initializers = [];
    var _availableLanguages_extraInitializers = [];
    ...
    var GlobalSettings = _classThis = /** @class */ (function (_super) {
        __extends(GlobalSettings_1, _super);
        function GlobalSettings_1(input) {
            var _this = _super.call(this, input) || this;
            /**
             * @deprecated use `Channel.availableLanguageCodes`
             */
            _this.availableLanguages = __runInitializers(_this, _availableLanguages_initializers, void 0);
            /**
             * @description
             ...
             */
            _this.trackInventory = (__runInitializers(_this, _availableLanguages_extraInitializers), __runInitializers(_this, _trackInventory_initializers, void 0));
            /**
             * @description
        ...
        return GlobalSettings_1;
    }(_classSuper));
    __setFunctionName(_classThis, "GlobalSettings");
    (function () {
        var _a;
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_a = _classSuper[Symbol.metadata]) !== null && _a !== void 0 ? _a : null) : void 0;
        _availableLanguages_decorators = [(0, typeorm_1.Column)('simple-array')];
        _trackInventory_decorators = [(0, typeorm_1.Column)({ default: true })];
        _outOfStockThreshold_decorators = [(0, typeorm_1.Column)({ default: 0 })];
        _customFields_decorators = [(0, typeorm_1.Column)(function (type) { return custom_entity_fields_1.CustomGlobalSettingsFields; })];
        __esDecorate(null, null, _availableLanguages_decorators, { kind: "field", name: "availableLanguages", static: false, private: false, access: { has: function (obj) { return "availableLanguages" in obj; }, get: function (obj) { return obj.availableLanguages; }, set: function (obj, value) { obj.availableLanguages = value; } }, metadata: _metadata }, _availableLanguages_initializers, _availableLanguages_extraInitializers);
        ...
        GlobalSettings = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return GlobalSettings = _classThis;
}();
