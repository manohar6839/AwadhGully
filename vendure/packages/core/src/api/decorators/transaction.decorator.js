...
var transaction_interceptor_1 = require("../middleware/transaction-interceptor");
 ...
 * @docsWeight 0
 */
var Transaction = function (transactionMode, transactionIsolationLevel) {
    if (transactionMode === void 0) { transactionMode = 'auto'; }
